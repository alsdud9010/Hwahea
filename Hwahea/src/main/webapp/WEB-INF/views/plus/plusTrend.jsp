...
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plus/plus.reply.js"></script>
<!--=== Content Part ===-->
	...
	<div class="row magazine-page">
		...
		<div class="col-md-12">
			...
			<div class="magazine-news">
				<div class="row">
					<div class="plusBest">
						<img src="${pageContext.request.contextPath}/assets/img/plus/plusTrend3.PNG">
						<div class="plusBanner2">
							<div class="lineforPlus"></div>
							<div class="spaceforPlus"></div>
							<input type="button" value="#신상&트렌드 01" disabled>
							<h2>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<img class="plusLike" src="${pageContext.request.contextPath}/assets/img/plus/modalLeft.png" data-dismiss="modal"> 
					<span class="modalCategory"> <a href="#">신상&amp;트렌드</a> </span>
				...
				<div class="modal-body pmodal_c" style="text-align: center;">
					...
					<div class="pmodal_lrs">
						<ul>
							<li class="pmodal_like"><img src="${pageContext.request.contextPath}/assets/img/plus/heart2.png"> 좋아요</li>
							<li class="pmodal_scrap"><img src="${pageContext.request.contextPath}/assets/img/plus/scrap2.png"> 스크랩</li>
					...
					<div class="pmodal_reply">
						...
						<div class="prere_back">
							<div class="pmodal_rere">
								...
								<div class="prere_text"><span class="rere_writer">white</span>ㅡㅡ?</div>
								<div class="pmodal_brere">
