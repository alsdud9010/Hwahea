				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="plusThumbnail">
							<!-- magazine-news-img -->
							<a href="#" data-toggle="modal" data-target="#plus_modal"><img src="${pageContext.request.contextPath}/assets/img/plus/plusThumbnail.PNG"></a>
						</div>
						<div class="plusTitle">
							<a data-target="#plus_modal" data-toggle="modal">눈화장에서 가장 중요한데
								의외로 모르는 것</a>
						</div>
