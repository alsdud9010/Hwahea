			...
			<div class="mypage_form">
				<div class="menu_bar">
					<ul class="list-inline top-v1-contacts">
						...
						<li>|</li>
						<li class="now_menu"><a href="${pageContext.request.contextPath}/mypage/my_favoriteuser.do">사용자</a></li>
						<li>|</li>
								...
								<button type="button" class="close" data-dismiss="alert" style="margin-top: -1em; margin-right: -1em;">&times;</button>
									<div id="center">
										<div class="favorite_img" style="margin-left: 5px;">
											<img alt="brand_img" src="${pageContext.request.contextPath}/assets/img/mypage/profile.png">
										</div>
										<hr>
