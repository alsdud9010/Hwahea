	                  	...
	                  	<ul class="event_list" id="eList">
		                  	<li>
		                  		...
		                  		<span class="event_wish">
		                  			 <a href="#"><img class="ewish_img" data-num="1" src="${pageContext.request.contextPath}/assets/img/shop/not_wish.png"></a>
		                  		</span>
		                  		...
		                  		<a href="${pageContext.request.contextPath}/event/eventView2.do" class="event_hover"><span>상세 보기</span></a>
		                  		</div>
		                  		<span class="event_wish">
		                  			 <a href="#"><img class="ewish_img" data-num="1" src="${pageContext.request.contextPath}/assets/img/shop/not_wish.png"></a>
		                  		</span>
		                  	...
		                  	<li>
		                  		...
		                  		<div class="event_info">
		                  			<div class="event_deadline">2018.08.27 ~ 2018.09.03</div>
		                  			<span class="event_kind">[화해 유목민]</span> 
		                  			<span class="event_left">남은 시간 6시간 56분</span>
		                  		</div>
		                  	</li>
		                  	<li>
